...
const Factorial = () => {
    ...
    return (
        <section className='h-[100vh] w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-200 via-pink-100 to-yellow-100 overflow-y-hidden'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <button type="submit" className='w-24 h-24 mt-10 bg-purple-500 text-white font-bold text-xl rounded-full shadow-lg hover:scale-110 hover:shadow-2xl active:scale-95 transition-transform duration-300'>Generate</button>
            </form>
      ...
      <div className="absolute bottom-10 right-10 bg-yellow-200 w-24 h-24 rounded-full blur-lg opacity-50 animate-pulse"></div> */}
            {
                showRes !== null && (
                    <p className="text-4xl mt-8 text-green-400 font-bold border-4">
